...
sleep 2
echo "task 1 to check if file is a regular file"
sleep 2
test -f /etc/resolv.conf && echo "/etc/resolv.conf is a regular file" || echo "/etc/resolve.conf file is not regular file"
sleep 2
echo "task 2 to check if file is a symbolic link"
sleep 2
test -h /etc/resolv.conf && echo "/etc/resolv.conf is a symbolic link" || echo "/etc/resolve.conf file is not symbolic link"
sleep 2
echo "task 3 to check if file is a directory"
sleep 2
test -d /etc/resolv.conf && echo "/etc/resolv.conf is a directory" || echo "/etc/resolve.conf file is not a directory"
sleep 2
echo "task 4 to check if file is readable"
sleep 2
test -r /etc/resolv.conf && echo "/etc/resolv.conf is readable" || echo "/etc/resolve.conf file is not readable"
sleep 2
echo "task 5 to check if file is writable"
sleep 2
test -w /etc/resolv.conf && echo "/etc/resolv.conf is writable" || echo "/etc/resolve.conf file is not writable"
sleep 2
echo "task 6 to check if file is executable"
sleep 2
test -x /etc/resolv.conf && echo "/etc/resolv.conf is executable" || echo "/etc/resolve.conf file is not executable"
sleep 2
...
[ -r /tmp ] && echo "/tmp is a readable" || echo "/tmp is not readable"
[ -w /tmp ] && echo "/tmp is a writable" || echo "/tmp is not writable"
